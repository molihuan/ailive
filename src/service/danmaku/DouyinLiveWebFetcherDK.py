...
class DouyinLiveWebFetcherDK(BaseDanmaku):
    """
    通过DouyinLiveWebFetcherDK获取抖音弹幕
    """
    ...
    def __init__(self, live_id):
        ...
        self.getDanmakuThread: SuperThread = None
    ...
    def startGetDanmakuThread(self):
        self.getDanmakuThread = SuperThread(target=self.getDanmakuTask)
        self.getDanmakuThread.start()

    def stopGetDanmakuThread(self):
        self.getDanmakuThread.stop()
        pass
    ...
    def _wsOnClose(self, ws):
        LogUtils.e("WebSocket connection closed.")
        pass
    ...
    def _parseGiftMsg(self, payload):
        ...
        # LogUtils.d(f"【礼物msg】{user_name} 送出了 {gift_name}x{gift_cnt}")
    ...
    def _parseLikeMsg(self, payload):
        ...
        user_name = message.user.nick_name
        count = message.count
        # LogUtils.d(f"【点赞msg】{user_name} 点了{count}个赞")
    ...
    def _parseMemberMsg(self, payload):
        ...
        # LogUtils.d(f"【进场msg】[{user_id}][{gender}]{user_name} 进入了直播间")
    ...
    def _parseSocialMsg(self, payload):
        ...
        user_name = message.user.nick_name
        user_id = message.user.id
        # LogUtils.d(f"【关注msg】[{user_id}]{user_name} 关注了主播")
    ...
    def _parseRoomUserSeqMsg(self, payload):
        ...
        # LogUtils.d(f"【统计msg】当前观看人数: {current}, 累计观看人数: {total}")

    def _parseFansclubMsg(self, payload):
        '''粉丝团消息'''
        message = FansclubMessage().parse(payload)
        content = message.content
        # LogUtils.d(f"【粉丝团msg】 {content}")
    ...
    def _parseEmojiChatMsg(self, payload):
        ...
        # LogUtils.d(f"【聊天表情包id】 {emoji_id},user：{user},common:{common},default_content:{default_content}")

    def _parseRoomMsg(self, payload):
        message = RoomMessage().parse(payload)
        common = message.common
        room_id = common.room_id
        # LogUtils.d(f"【直播间msg】直播间id:{room_id}")

    def _parseRoomStatsMsg(self, payload):
        message = RoomStatsMessage().parse(payload)
        display_long = message.display_long
        # LogUtils.d(f"【直播间统计msg】{display_long}")

    def _parseRankMsg(self, payload):
        message = RoomRankMessage().parse(payload)
        ranks_list = message.ranks_list
        # LogUtils.d(f"【直播间排行榜msg】{ranks_list}")
